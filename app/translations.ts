    ...
    services: {
      ...
      items: [
        ...
        },
        {
          num: "02",
          title: "官方網站",
          desc: "建置企業官方網站與行銷頁面，整合 Google Analytics 網站分析、Google Search Console 搜尋主控台與 SEO 搜尋引擎優化，打造企業品牌形象並提升客戶詢問與成交機會。",
        ...
        },
        {
          num: "05",
          title: "LINE 官方帳號整合",
          desc: "完成 LINE 官方帳號設定、訊息串接服務與 LINE LIFF 應用程式串接，建立圖文選單、自動回覆與客戶管理系統同步，把 LINE 變成可管理的客戶通道。",
        ...
        },
        {
          num: "06",
          title: "系統串接",
          desc: "串接 OpenAI、Google、Stripe、Supabase 等第三方服務，建立穩定的系統串接架構、錯誤重試與資料同步，支援產品擴充。",
        ...
        },
        {
          num: "07",
          title: "流程自動化",
          desc: "把表單、審批、通知與報表等重複流程自動化，串接電子郵件、LINE 與內部系統，減少人工轉檔與漏單風險。",
          idealFor: "跨部門仍靠電子郵件或通訊軟體協調、希望標準化處理的營運團隊",
          deliverables: [
            "電子郵件通知",
            "LINE 通知",
            "流程自動化",
  ...
  en: {
    ...
    projects: {
      ...
      detail: {
        ...
        clientRequirements: "Client Challenge",
        solution: "Solution",
