      ...
      items: [
        {
          num: "01",
          title: "AI 系統開發",
          desc: "依企業場景設計對話與代理流程，串接 OpenAI 與內部資料，讓客服回覆、知識查詢與業務判斷能穩定自動運作。",
          idealFor: "客服量大、需全天候回覆，或想把內部文件轉成可問答系統的團隊",
          deliverables: [
            "AI Chatbot",
            "AI Agent",
            "OpenAI 整合",
        ...
        },
        {
          num: "02",
          title: "客製化網站開發",
          desc: "從企業官網、SaaS 入口到線上預約站，依品牌與營運需求客製前後端，並確保多語系與各裝置瀏覽體驗一致。",
          idealFor: "需要對外形象站、產品展示頁，或要把預約與會員流程放上線的企業",
          deliverables: [
            "企業形象網站",
            "SaaS 平台",
            "線上預約系統",
        ...
        },
        {
          num: "03",
          title: "CRM／企業管理系統",
          desc: "依實際銷售與營運節奏建置客戶管理後台，整合商機階段、任務提醒與權限分工，讓團隊在同一套資料上協作。",
          idealFor: "客戶資料分散在 LINE、表單或試算表，跟進容易遺漏的業務與營運團隊",
          deliverables: [
            "客戶管理",
            "Dashboard",
            "商機追蹤",
        ...
        },
        {
          num: "04",
          title: "LINE 官方帳號整合",
          desc: "完成官方帳號設定、Messaging API 與 Webhook 串接，建立自動回覆與預約流程，並把對話紀錄同步寫入 CRM。",
          idealFor: "以 LINE 為主要客戶接觸管道、想把訊息轉成可追蹤商機的台灣企業",
          deliverables: [
            "LINE Messaging API",
            "Webhook",
            "自動回覆",
        ...
        },
        {
          num: "05",
          title: "API 串接整合",
          desc: "串接 OpenAI、Google 日曆與會議、Stripe 金流及 PostgreSQL 等服務，建立穩定資料流、錯誤重試與監控機制。",
          idealFor: "已有系統需對接第三方 API，或要把金流、排程與 AI 能力整合進產品的團隊",
          deliverables: [
            "OpenAI API",
            "Google Calendar API",
            "Google Meet API",
        ...
        },
        {
          num: "06",
          title: "AI 自動化流程",
          desc: "把表單提交、審批與通知等重複作業自動化，搭配 AI 解析內容並觸發後續步驟，減少人工轉檔與漏單風險。",
          idealFor: "跨部門流程仍靠 Email 或聊天轉發、希望標準化處理與即時通知的營運團隊",
          deliverables: [
            "表單自動化",
            "Email 通知",
            "工作流程自動化",
      ...
      items: [
        {
          ...
          desc: "We design chat and agent flows around your operations, connect OpenAI to internal data, and keep support replies and knowledge lookup running reliably.",
          idealFor: "Teams with heavy support load, 24/7 coverage needs, or internal docs that should become searchable Q&A",
          deliverables: [
            "AI Chatbot",
            "AI Agent",
            "OpenAI integration",
        ...
        },
        {
          ...
          desc: "From corporate sites and SaaS portals to booking flows — we build front and back ends to match your brand, multilingual needs, and device mix.",
          idealFor: "Companies launching a public site, product pages, or online booking and member flows",
          deliverables: [
            "Corporate websites",
            "SaaS platforms",
        ...
        },
        {
          ...
          desc: "Customer management back offices shaped to your sales rhythm — pipeline stages, task alerts, and role-based access so teams work from one source of truth.",
          idealFor: "Sales and ops teams with leads spread across LINE, forms, or spreadsheets and missed follow-ups",
          deliverables: [
            "Customer management",
            "Dashboard",
        ...
        },
        {
          ...
          desc: "Official Account setup, Messaging API and webhooks, auto-replies and booking flows — with conversations synced into your CRM.",
          idealFor: "Taiwan businesses where LINE is the primary customer channel and messages should become trackable leads",
          deliverables: [
            "LINE Messaging API",
            "Webhook",
            "Auto-replies",
        ...
        },
        {
          ...
          desc: "Connect OpenAI, Google Calendar and Meet, Stripe, PostgreSQL, and more — with stable data pipelines, retries, and monitoring.",
          idealFor: "Teams wiring third-party APIs into existing products or combining payments, scheduling, and AI in one stack",
          deliverables: [
            "OpenAI API",
            "Google Calendar API",
            "Google Meet API",
        ...
        },
        {
          ...
          desc: "Automate form intake, approvals, and notifications; use AI to interpret submissions and trigger the next step — less manual forwarding and fewer dropped tasks.",
          idealFor: "Ops teams still routing work through email or chat handoffs who want standardized processing and alerts",
          deliverables: [
            "Form automation",
            "Email notifications",
            "Workflow automation",
